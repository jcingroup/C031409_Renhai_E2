...
module services {
    export class workOrdersDetailService {
...
angular.module('angularApp', ['commfun', 'ui.bootstrap'])
    ...
    .controller('ctrl', ['$scope', '$http', '$q', '$modal', 'gridpage', 'workService',
        function (
            ...
            gridpage,
            workService: services.workOrdersDetailService
            ) {
...
interface IOrdersDetailEdit2 extends IScopeM<server.Orders_Detail> {
    ok(): void;
    cancel(): void;
    born_sign: string[];
    born_time: CBornTime[];
...
var modalEditMember = ['$scope', '$http', '$modalInstance', 'items', 'notifyCtrl',
    function ($scope: IOrdersDetailEdit2, $http: ng.IHttpService, $modalInstance, items, notifyCtrl) {
