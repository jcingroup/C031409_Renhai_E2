...
'===變數定訂===
Dim MasterID '戶帳序號
Dim p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p19,p20,p21,p22
...
'===程新開始	
	If Trim(Request.Form("cmd"))="set" Then 	'新增
		...
		p17=Trim(Request.Form("p17"))		'member_detail_category_id
		p19=Trim(Request.Form("p19")) 		'是否潤月
		p20=Trim(Request.Form("p20")) 		'備註、祈福事項
		p21=Trim(Request.Form("p21")) 		'身分字號(契子觀摩用)
		p22=Trim(Request.Form("p22")) 		'國立投保生日(契子觀摩用)
		p4Array		= Split(p4,"/")
		...
		rs("縣市")	=	p13
		rs("鄉鎮")	=	p14
		rs("member_detail_category_id")	=	p17
