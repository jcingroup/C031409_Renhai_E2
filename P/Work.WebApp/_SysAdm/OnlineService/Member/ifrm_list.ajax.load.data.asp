...
Dim RecordCount
	...
	'======================================================
	'-- 組合表單-------------------------------------------
	aryIns=Array("新增訂單","RedireOrder()","沉香媽祖/藥師佛斗燈","RedireOrder_DouLight()","福燈","RedireOrder_Fortune()","新增家庭成員","AddNewMember()","主副斗","RedireOrderM()","大中小斗","RedireOrderMBMS()","祈福許願燈","RedireOrderWishLight()")
	aryDel=Array("刪除")
