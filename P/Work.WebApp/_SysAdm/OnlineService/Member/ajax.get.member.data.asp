...
'===程新開始
	...
	'序號, 戶長SN, Is戶長, 姓名, 電話區碼, 電話尾碼, 郵遞區號, 地址, 手機, 性別, 生日, 時辰, EMAIL, 祈福事項, 生肖, 縣市, 鄉鎮,son,insure_birthday
	...
	ReturnSYSJson("isOnLeapMonth")	= rs.fields("isOnLeapMonth").value	
	ReturnSYSJson("member_detail_category_id")	= rs.fields("member_detail_category_id").value		
	ReturnSYSJson("祈福事項")	= rs.fields("祈福事項").value	
	ReturnSYSJson("sno")	= rs.fields("sno").value	
	ReturnSYSJson("insure_birthday")	= rs.fields("insure_birthday").value	
