...
namespace DotWeb.Controllers
{
    public class OrdersController : BaseController
    {
        ...
        #region 媽祖斗燈 、藥師佛斗燈
        [HttpPost]
        public string AddOrdersDouLight(cartMaster master, string product_sn, int[] member_detail_ids)
        {
            rAjaxGetData<string> r = new rAjaxGetData<string>();
            cartMaster cart = (cartMaster)Session[this.sessionCart];
            ...
            try
            {
                ...
                Orders m = new Orders()
                {
                    ...
                    mobile = master.mobile,
                    orders_state = (int)Orders_State.complete,
                    orders_type = (int)Orders_Type.doulight
                };
        ...
        [HttpPut]
        public string UpdateOrdersDouLight(cartMaster master, int[] member_detail_ids)
        {
            rAjaxGetData<Orders> r = new rAjaxGetData<Orders>();
            cartMaster cart = (cartMaster)Session[this.sessionCart];
        ...
        [HttpGet]
        public string DeleteOrdersDouLight(string orders_sn)
        {
            ResultInfo r = new ResultInfo();
