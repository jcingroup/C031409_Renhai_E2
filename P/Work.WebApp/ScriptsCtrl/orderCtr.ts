                            ...
                            if (data.result) {
                                ...
                                $http.get(gb_approot + 'Cart/OrdersToSession', { params: { orders_sn: data.data } })
                                    .success(function (data: IResultData<server.cartMaster>, status, headers, config) {
                                        if (data.result) {
                                            $scope.fd = data.data;
                                            $scope.edit_type = 2;//IEditType.update;
