angular.module('angularApp', ['commfun', 'siyfion.sfTypeahead']).config(['$httpProvider', function ($httpProvider) {
    ...
    function GetOrder(order_sn) {
        workService.getOrderData(order_sn).success(function (data, status, headers, config) {
            if (data.result) {
    ...
    function ClearCart() {
        $http.delete(gb_approot + 'Cart/ClearCart', { params: { t: uniqid() } }).success(function (data, status, headers, config) {
            if (!data.result) {
                alert(data.message);
            }
        }).error(function (data, status, headers, config) {
    ...
    $scope.Master_Open_Modify = function (orders_sn) {
        $http.get(gb_approot + 'Orders/CheckOrderType', { params: { orders_sn: orders_sn } }).success(function (data, status, headers, config) {
            if (data.message != '') {
                ...
                $http.delete(gb_approot + 'Cart/ClearCart', { params: {} }).success(function (data, status, headers, config) {
                    if (data.result) {
