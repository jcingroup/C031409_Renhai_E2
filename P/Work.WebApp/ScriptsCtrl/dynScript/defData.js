...
(function (commData) {
    ...
    commData.Fortune_light = [
        { value: "", label: "All" },
        { value: "390", label: "頭燈前排福燈" },
        { value: "391", label: "頭燈後排福燈" },
        { value: "392", label: "前排福燈" },
        { value: "393", label: "右排福燈" },
    ...
    commData.godson_account_type_forsearch = [
        { value: "", label: "All" },
        { value: "751", label: "契子入會" },
        { value: "752", label: "契子大會" }
    ];
    ...
    commData.member_label_print = [
        { value: "320", label: "中壢320" },
        { value: "324", label: "平鎮324" },
        { value: "326", label: "楊梅326" },
        { value: "Other", label: "其他未分" }
    ];
    commData.twDistrict = [
        {
            city: '基隆市',
