...
angular.module('angularApp').controller('ctrl', ['$scope', '$http', 'workService', 'gridpage', '$sce', 'ngDialog', '$state', '$cookies', function ($scope, $http, workService, gridpage, $sce, ngDialog, $state, $cookies) {
    console.log('ctrl');
...
angular.module('angularApp').controller('ctrl_master', ['$scope', '$http', 'workService', '$sce', 'ngDialog', '$state', '$q', function ($scope, $http, workService, $sce, ngDialog, $state, $q) {
    ...
    function SendGeneralOrder() {
        if ($scope.edit_type == 1 /* insert */) {
            $http.post(gb_approot + 'Orders/AddOrders', $scope.fd).success(function (data, status, headers, config) {
                if (data.result) {
        ...
        if ($scope.edit_type == 2 /* update */) {
            $http.put(gb_approot + 'Orders/UpdateOrders', $scope.fd).success(function (data, status, headers, config) {
                if (data.result) {
                    $scope.edit_type = 2 /* update */;
                    $scope.$parent.Init_Query();
                    alert('訂單修改完成');
    ...
    function SendSDLightOrder() {
        if ($scope.edit_type == 1 /* insert */) {
            $http.post(gb_approot + 'Orders/AddSDLight', $scope.fd).success(function (data, status, headers, config) {
                if (data.result) {
                    $http.get(gb_approot + 'Cart/OrdersToSession', { params: { orders_sn: data.data } }).success(function (data, status, headers, config) {
                        if (data.result) {
                            $scope.fd = data.data;
        ...
        ;
        if ($scope.edit_type == 2 /* update */) {
            $http.put(gb_approot + 'Orders/UpdateSDLight', $scope.fd).success(function (data, status, headers, config) {
                if (data.result) {
                    $scope.edit_type = 2 /* update */;
                    $scope.$parent.Init_Query();
                    alert('訂單修改完成');
    ...
    function GetOrder(orders_sn) {
        workService.getOrderData(orders_sn).success(function (data, status, headers, config) {
            if (data.result) {
    ...
    function GetMemberAll(member_id) {
        return workService.getMemberAll(member_id).success(function (data, status, headers, config) {
            if (data.result) {
                $scope.mb = data.data;
            }
            else {
    ...
    function GetMemberByDetail(member_id) {
        var r = workService.getMemberByDetail(member_id).success(function (data, status, headers, config) {
            if (data.result) {
    ...
    function GetProductAll() {
        workService.getProductAll().success(function (data, status, headers, config) {
            if (data.result) {
                $scope.pds = data.data;
            }
            else {
    ...
    ;
    function GetFortune() {
        $http.get(gb_approot + apiGetAction + '/GetFortune').success(function (data, status, headers, config) {
            if (data.result) {
    ...
    function GetManjushri() {
        workService.getManjushri().success(function (data, status, headers, config) {
            if (data.result) {
                $scope.mjs = data.data;
            }
            else {
    ...
    function GetNowCartList() {
        $http.get(gb_approot + 'Cart/ListCartItems', { params: {} }).success(function (data, status, headers, config) {
            if (data.result) {
    ...
    function SetMemberToCart() {
        $http.post(gb_approot + 'Cart/SetCartMaster', $scope.fd).success(function (data, status, headers, config) {
            if (data.result) {
            }
            else {
                alert(data.message);
    ...
    function ClearCart() {
        $http.get(gb_approot + 'Cart/ClearCart', { params: { t: uniqid() } }).success(function (data, status, headers, config) {
            if (!data.result) {
                alert(data.message);
            }
        }).error(function (data, status, headers, config) {
    ...
    function GetLight(product_sn) {
        workService.getLightByMD(product_sn).success(function (data, status, headers, config) {
            if (data.result) {
    ...
    function MasterDataView(orders_sn) {
        var q = $q.defer();
        $http.get(gb_approot + 'Orders/CheckOrderType', { params: { orders_sn: orders_sn } }).success(function (data, status, headers, config) {
            if (data.message != '') {
                document.location.href = data.message;
            }
            else {
                $http.get(gb_approot + 'Cart/ClearCart', { params: {} }).success(function (data, status, headers, config) {
                    if (data.result) {
                        $http.get(gb_approot + 'Orders/GetToSession', { params: { orders_sn: orders_sn } }).success(function (data, status, headers, config) {
                            if (data.result) {
                                $scope.fd = data.data;
                                ...
                                if (LocalDate.getFullYear() == nowToday.getFullYear() && LocalDate.getMonth() == nowToday.getMonth() && LocalDate.getDate() == nowToday.getDate()) {
...
angular.module('angularApp').controller('ctrl_general', ['$scope', '$http', 'workService', '$sce', 'ngDialog', '$state', function ($scope, $http, workService, $sce, ngDialog, $state) {
    ...
    ;
    function GetMemberAll(member_id) {
        workService.getMemberAll(member_id).success(function (data, status, headers, config) {
            if (data.result) {
                $scope.mb = data.data;
            }
            else {
    ...
    ;
    function GetMemberByDetail(member_id) {
        workService.getMemberByDetail(member_id).success(function (data, status, headers, config) {
            if (data.result) {
                if (member_id != data.data.member_id) {
                    alert('系統回傳member_id不一致');
                    return;
...
angular.module('angularApp').controller('ctrl_fortune', ['$scope', '$http', 'workService', '$sce', 'ngDialog', '$state', function ($scope, $http, workService, $sce, ngDialog, $state) {
    ...
    ;
    function GetProductAll() {
        workService.getProductFortune().success(function (data, status, headers, config) {
            if (data.result) {
                $scope.pds = data.data;
            }
            else {
    ...
    if ($scope.edit_type == 2 /* update */) {
        workService.getFortune($state.params.orders_sn).success(function (fdata, status, headers, config) {
    ...
    $scope.DeleteOrderFourtune = function () {
        if (confirm('確定刪除訂單?')) {
            $http.get(gb_approot + 'Orders/DeleteOrdersFortune', { params: { orders_sn: $scope.fd.orders_sn } }).success(function (data, status, headers, config) {
                if (data.result) {
                    $scope.Init_Query();
                    $scope.$parent.GoGrid();
                }
...
angular.module('angularApp').controller('ctrl_sdlight', ['$scope', '$http', 'workService', '$sce', 'ngDialog', '$state', function ($scope, $http, workService, $sce, ngDialog, $state) {
    console.log('ctrl_general');
    var p0 = 0;
    var allowSetPrice = ['香油'];
    var allowSetRace = ['白米'];
    ...
    ;
    function GetProductAll() {
        workService.getProductSDLight().success(function (data, status, headers, config) {
            if (data.result) {
                $scope.pds = data.data;
            }
            else {
...
angular.module('angularApp').controller('ctrl_mdlight', ['$scope', '$http', 'workService', '$sce', 'ngDialog', '$state', function ($scope, $http, workService, $sce, ngDialog, $state) {
    var p0 = 0;
    var allowSetPrice = ['香油'];
    var allowSetRace = ['白米'];
    var allowSetGold = ['金牌'];
    ...
    $scope.SubmitCart = function () {
        $scope.cart.isOnOrder = false;
        $http.post(gb_approot + 'Cart/AddLightCart', $scope.cart).success(function (data, status, headers, config) {
            if (data.result) {
                GetNowCartList();
            }
            else {
    ...
    ;
    function GetProductAll() {
        workService.getProductMDLight().success(function (data, status, headers, config) {
            if (data.result) {
                $scope.pds = data.data;
            }
            else {
...
angular.module('angularApp').controller('ctrl_wishlight', ['$scope', '$http', 'workService', '$sce', 'ngDialog', '$state', function ($scope, $http, workService, $sce, ngDialog, $state) {
    ...
    ;
    function GetProductAll() {
        workService.getProductWishLight().success(function (data, status, headers, config) {
            if (data.result) {
                $scope.pds = data.data;
            }
            else {
...
angular.module('angularApp').controller('ctrl_doulight', ['$scope', '$http', 'workService', '$sce', 'ngDialog', '$state', function ($scope, $http, workService, $sce, ngDialog, $state) {
    ...
    ;
    function GetProductAll() {
        workService.getProductDouLight().success(function (data, status, headers, config) {
            if (data.result) {
                $scope.pds = data.data;
            }
            else {
    ...
    $scope.DeleteOrderFourtune = function () {
        if (confirm('確定刪除訂單?')) {
            $http.get(gb_approot + 'Orders/DeleteOrdersDouLight', { params: { orders_sn: $scope.fd.orders_sn } }).success(function (data, status, headers, config) {
                if (data.result) {
                    $scope.Init_Query();
                    $scope.$parent.GoGrid();
                }
